...
public class Shooter {
    ...
    public static float shootingCoefficient = 2.715f;
    ...
    public void shoot() {
        ...
        if (shooting && !dumpShot) {
            ...
            if (Math.abs(calculatedAngle - tempAngle) > 0.004) {
                ...
                // setHoodYet) {
                double thresholdVelocity = ((((((calculatedVelocity * shootingCoefficient * 11.666 - 500.0) * 1.0728) * 1.00175) / 1.008) / 1.028) * 1.015);
